      ...
      <div className="max-w-md w-full space-y-8 p-8 z-10">
        <div className="flex flex-col items-center">
          ...
          <h2 className="mt-2 text-center text-3xl font-extrabold text-white">
            Create your Sphaire account
          </h2>
          <p className="mt-2 text-center text-sm text-gray-400">
            Start building amazing 3D designs today
          </p>
        </div>
        ...
        <div className="bg-gray-900 bg-opacity-80 backdrop-blur-sm rounded-lg shadow-xl p-8 space-y-6 border border-gray-800">
          ...
          <div className="text-center">
            <p className="text-sm text-gray-400">
              ...
              <Link href="/login" className="font-medium text-pink-400 hover:text-pink-300 transition-colors duration-200">
                Sign in
              </Link>
            </p>
          </div>
